...
namespace Schoolable.Controllers
{
    ...
    public class ComptesController : ControllerBase
    {
        ...
        public ComptesController(SchoolableContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Comptes/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Compte>> GetCompte(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCompte(long id, Compte compte)
        {
            if (id != compte.Id)
            {
                return BadRequest();
        ...
        private bool CompteExists(long id)
        {
